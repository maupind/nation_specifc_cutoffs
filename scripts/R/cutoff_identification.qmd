...
clin_hmse <- H_DAD %>% 
 mutate(hmse_flag = if_else(r1fyr > 0 |
                               r1fdate > 0 |
                               r1fdw > 0 |
                               r1fmo > 0 |
                               r1fstate > 0 |
...
# Define cutoff scores with which to compare against CDR rating. For example test_1_cutoffs will create a sequence from 3 to 5 counting by 0.1 equating jorm scores ranging from 3.0 to 5
