...
lasi_ml_data <- lasi_overall %>% 
  select(prim_key,
         ...
         r1inf_rel,
         # Informant whether provides care for R
         r1inf_care,
         ...
         # word learning total
         r1word_total,
         # Word List recognition original
         r1wre_org,
         # word list recognition new
         r1wre_foil,
         # word list recognition (org + foil)
         r1wre_score,
         ...
         r1bm_s1:r1bm_recl_d,
         ## Robbery story 
         r1lmb_s1:r1lmb_recl_d,
         # Logical memory recall
         r1log_rcmix,
         r1log_wron,
         r1log_reco,
         # Constructional Praxis
         r1cp_circle:r1cpr_score,
         # Clock Drawing
         r1dr_clock3,
         # Raven's test
         r1rv_score,
         # Go-no-go
         r1go_score1:r1go_score,
         # Serial 7s
         r1ser7.x,
         # Symbol Cancellation
         r1sc_anw,
...
long_lasi_ind_clin <- long_lasi_ml %>%
    pivot_longer(cols = c(r1raterid_1, r1raterid_2, r1raterid_3), 
