...
# Filter participants to those from rural locations
clin0['hh1rural'] = clin0['hh1rural'].astype(int)
clin0 = clin0[clin0['hh1rural'] == 1]


# Dropping unneccesarry predictors
...
for train_idx, val_idx in skf.split(X_train_full, y_train_full):
    ...
    for i in range(num_iterations):
        ...
        # Run the Bayesian Optimisation function
    ...
    # Convert lists to tensors for Gaussian Process model training
